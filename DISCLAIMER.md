...
- **Professional Rules**: Law Society of Congo (DRC) members must comply with applicable professional conduct rules when using AI tools
...
1. Checking the official source (Congo (DRC) Law Reports (congoleselaw.org), Congo (DRC) Gazette)
...
This Tool aggregates data from official Congo (DRC) legal databases. However:
...
- Congo (DRC) law changes continuously through new statutes, amendments, and court decisions
...
2. **Official Verification**: Cross-check ALL results with official sources (Congo (DRC) Law Reports (congoleselaw.org), Congo (DRC) Gazette)
...
This disclaimer may be updated as the Tool evolves or legal/regulatory requirements change. Check the [GitHub repository](https://github.com/Ansvar-Systems/Congo (DRC)-law-mcp) for the current version.

## Questions?

For questions about this disclaimer or the Tool's limitations, please open an issue on GitHub:
https://github.com/Ansvar-Systems/Congo (DRC)-law-mcp/issues
