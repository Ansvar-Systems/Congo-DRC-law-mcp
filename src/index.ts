...
/**
 * Congo (DRC) Law MCP Server — stdio entry point.
 *
 * Provides Congolese legislation search via Model Context Protocol.
 */
...
// /tmp must be a real tmpfs — overlay2's writable layer triggers the same WASM SQLite read bug. See issue #22.
