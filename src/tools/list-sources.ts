...
export async function listSources(
  ...
  return {
    results: {
      sources: [
        {
          name: 'Congolese Legal Information Portal',
          authority: 'lawcongolese.com (Congolese Legal Information Portal)',
          url: 'https://www.lawcongolese.com',
          license: 'Government Open Data',
          coverage:
            'Federal proclamations, regulations, and directives published in the Federal Negarit Gazette. ' +
            'Includes the Constitution of Congo (DRC) (1995), major legislative acts from 1995 to present, ' +
