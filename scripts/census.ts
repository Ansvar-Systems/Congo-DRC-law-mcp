#!/usr/bin/env tsx
/**
 * Congo (DRC) Law MCP -- Census Script
 *
 * Enumerates ALL proclamations, regulations, and directives from lawcongolese.com.
...
const BASE_URL = 'https://www.lawcongolese.com';
...
const FEDERAL_CATEGORIES = [
  ...
  'banking-and-monetary-system/national-bank-of-congolese',
  ...
  'parliament', 'police', 'president-of-congolese', 'prison',
...
async function scrapeCategoryPage(categoryPath: string): Promise<RawLaw[]> {
  ...
  for (const link of links) {
    ...
    if (link.href.startsWith('http') && !link.href.includes('lawcongolese.com')) continue;
...
async function main(): Promise<void> {
  ...
  console.log('Congo (DRC) Law MCP -- Census Script');
  console.log('=================================\n');
  ...
  console.log(`  Jurisdiction:   Congo (DRC) (ET)`);
  console.log(`  Source:         ${BASE_URL}`);
